...
api.add_output("time_primary", ["log", "linear"])
api.add_output("strain_primary", ["log", "linear"])

api.add_output("time_secondary", ["log", "linear"])
api.add_output("strain_secondary", ["log", "linear"])

api.add_output("time_tertiary", ["log", "linear"])
api.add_output("strain_tertiary", ["log", "linear"])

api.add_output("time_failure", ["log", "linear"])
api.add_output("strain_failure", ["log", "linear"])
